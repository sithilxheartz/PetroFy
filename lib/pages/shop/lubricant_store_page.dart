    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // REMOVED SAFEAREA: This allows the Column to fill the whole screen
          Column(
            children: [
              // Provides space for the transparent AppBar
                ...
                child: StreamBuilder<List<LubricantModel>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return GridView.builder(
                      // BOTTOM PADDING (140): This is the key. 
                      // It lets items scroll up past your floating navbar.
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(product.brand, style: const TextStyle(color: AppColors.textDim, fontSize: 10, fontWeight: FontWeight.bold)),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Rs.${product.sellingPrice.toInt()}", style: const TextStyle(color: AppColors.primaryGreen, fontSize: 14, fontWeight: FontWeight.w900)),
