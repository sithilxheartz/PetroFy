...
class PumperFuelLevelDashboard extends StatefulWidget {
  const PumperFuelLevelDashboard({super.key});

  @override
  State<PumperFuelLevelDashboard> createState() => _FuelLevelDashboardState();
}

class _FuelLevelDashboardState extends State<PumperFuelLevelDashboard>
